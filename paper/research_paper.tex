...
% Temporarily disable forced page breaks for sections
...
\end{itemize}
% Keep the following three sections together
\begin{samepage}
...
% Restore normal section behavior for subsequent chapters
...
\bibitem{wang2023uncertainty}
S. Wang, Y. Zhang, and Z. Li,
``Uncertainty Prediction for Monocular 3D Object Detection,''
\emph{Sensors}, vol. 23, no. 12, p. 5395, 2023.

\bibitem{jia2023monouni}
